package com.balsamiq.reconciliation.model;

import com.balsamiq.reconciliation.filter.ResemblingRecordFilter;

/**
 * The pair of records. Used by {@link ResemblingRecordFilter} in order to
